...
<head>
    ...
    <link rel="stylesheet" href="./public/css/paymentATM.css">
</head>
    ...
    <div class="container">
        <header>
            ...
            <div class="nav navbar-nav navbar-right">
                <div class="language">
                    <a class="ic-vi" href=""><img src="./public/images/ic_vi.png" height="16" width="24" alt=""></a>
                    <a class="ic-en" href=""><img src="./public/images/ic_en.png" height="16" width="24" alt=""></a>
                </div>
            </div>
        </header>
        <div class="main row">
                        ...
                        <div class="tab-pane">
                            <form action="">
                                <div class="notification number-card">
                                    ...
                                    <div class="group"><img src="./public/images/vietcombank_icon.png" alt="" width="60" height="36"></div>
                                </div>
        ...
        <footer>
            ...
            <div class="verify">
                <a href=""><img src="./public/images/ATMfooter.png" height="40" alt=""></a>
                <a href=""><img src="./public/images/ATMfooterPCI.png" height="40" alt=""></a>
            </div>
        </footer>
    </div>
    <script>
